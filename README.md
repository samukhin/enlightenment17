...
Адаптировано под ubuntu 22.04 и 24.04 (24.04  могут быть ошибки с edje_cc при сборке пакетов, решение - собирать с gcc-11 (не -std=c11, а прямо полноценный gcc-11) вместо gcc-13 хотя бы библиотеку eina, gcc-12 не пробовал. Решение по итогу - флаг -D_FORTIFY_SOURCE=2 в eina ), собирается и с 1.7.9 и с 1.7.10, но есть небольшие проблемы с evas_generic_loaders и enlightenment иногда запускается с чёрным экраном после первоначальной настройки (если выбран opengl).
