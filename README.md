...
Адаптировано под ubuntu 22.04 (24.04  пока ошибки с edje_cc при сборке пакетов), собирается и с 1.7.9 и с 1.7.10, но есть небольшие проблемы с evas_generic_loaders и enlightenment иногда запускается с чёрным экраном после первоначальной настройки..
